...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    smsSent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    status: Schema.Attribute.Enumeration<['paid', 'pending', 'overdue']> &
      Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['cash', 'card', 'transfer']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    guests: Schema.Attribute.Relation<'oneToMany', 'api::guest.guest'>;
    hasBalcony: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    hasPrivateBathroom: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    hostel: Schema.Attribute.Relation<'manyToOne', 'api::hostel.hostel'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    pricePerBed: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
